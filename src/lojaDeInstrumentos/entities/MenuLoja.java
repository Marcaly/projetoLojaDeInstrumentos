...
public class MenuLoja {
    ...
    public String getItemEscolhido() {
        ...
        if (itemEscolhido.equals("1") || itemEscolhido.equals("2") || itemEscolhido.equals("3")) {
            itemEscolhidoInt = Integer.parseInt(itemEscolhido);
        }
        if (itemEscolhidoInt == 1) {
            return "%n" +
